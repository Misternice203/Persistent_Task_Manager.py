...
print("=" * 30)
print()
print("This program allows you to create, read, update, and delete Tasks.")
...
while True:
    ...
    if choice < 1 or choice > 5:
        ...
        while True:
            ...
            Name = (input("What task would you like to Add?: "))
        ...
        if not tasks:
            ...
            for i, task in enumerate(tasks, start=1):
                status = "Completed" if task.get("completed", False) else "Not Completed"
